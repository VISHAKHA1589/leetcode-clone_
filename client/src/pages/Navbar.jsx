...
const Navbar = () => {
  return (
    <>
      <nav
        className="navbar navbar-expand-lg navbar-light bg-body-primary fs-5 justify-content-around lg:p-5"

        // Apply padding directly
      >
        <div className="container-fluid d-flex align-items-center ">
          <Link to="/">
            <a className="navbar-brand ml-lg-10">
              <svg
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 text-secondary gap-4">
